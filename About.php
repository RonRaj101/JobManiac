...
<body>
    <br>
  <center>
    <a style="text-decoration: none;" href="<?php echo $link?>"><h1 class="logo"><img src="logoinv.png" width="50px" height="50px" alt=""> QUICK NOKRI.com</h1></a>
  </center> 
