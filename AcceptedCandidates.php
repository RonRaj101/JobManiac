   ...
   ?>
    ...
    <div id="" style=" margin: 0px auto; width:40vw; height:25vh; box-shadow: rgba(0, 0, 0, 0.5) 0px 0px 3px; padding: 1vw; border:2px solid blue;">
        ...
        <div style="width:10vw; float:left; margin-left: 1vw;">
            ...
            <a  href="<?php echo $i['cvfileurl']?> "  target="_blank">
                <h6>Check CV</h6>
            </a>
        </div>
        <br><br>
        <a href=""><input type="button" class="btn btn-info" style="float: right; width: 17vw; border-radius:0px;"
                value="Waiting For Employee Approval.." disabled></a>
    </div>
    <br>
    <?php
    }
